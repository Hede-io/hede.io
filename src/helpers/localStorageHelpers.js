...
export const setLeftTitlesLanguage = (lang) => {
  //const lang = store.get('leftLanguage') || "all";
  //delete users[username];
  store.set('leftLanguage', lang);
  return true;
};


export const getLeftTitlesLanguage = () => {
  //const lang = store.get('leftLanguage') || "all";
  //delete users[username];
  store.get('leftLanguage') || "all";
  return true;
};
