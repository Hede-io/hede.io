...
import leftTitlesReducer from './reducers/leftTitles';
import titlesLoadingReducer from './reducers/titlesLoading';
import titleReducer from './reducers/title';
import totalTitlesReducer from './reducers/totalTitles';
import titlesFoundReducer from './reducers/titlesFound';
import uiViewReducer from './reducers/ui';
import submittingReducer from './reducers/submitting';
...
const reducers = combineReducers({
  ...
  posts: postsReducer,
  loading: loadingReducer, // @HEDE
  moderators: moderatorsReducer, // @HEDE
  feed: feedReducer,
  user: userReducer,
  users: usersReducer,
  ...
  leftTitlesLoading: titlesLoadingReducer,
  leftTitles: leftTitlesReducer,
  currentTitle: titleReducer,
  totalTitles: totalTitlesReducer,
  titlesFound: titlesFoundReducer,
  leftTitlesVisible: uiViewReducer,
...
export const getIsUserFetching = state=> fromAuth.getIsUserFetching(state.auth);
