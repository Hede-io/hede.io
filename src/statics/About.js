  ...
  (<div className="main-panel">
    <div className="mt-5 text-center">
      ...
      <p className="container pb-5">
        <FormattedMessage
          id="@statics/hede_mission"
          defaultMessage="This  project’s mission is to connect everyone to the next-gen decentralized knowledge sharing network that gives voice and value back to people, by building together a true sharing economy, a more free and trustworthy Internet without middleman."
        />
      </p>
      <div className="About__1 hero">
        <div className="container">
          ...
          <p>
            ...
            />{' '}
            <FormattedMessage
              id="@statics/hede_mission3"
              defaultMessage="As a non-profit and decentralized organization, Hede provides the power of cryptocurrency and blockchain innovations within a platform that returns much of its value to the creators ensuring fair compensation."
            />
          </p>
        </div>
      </div>
        ...
        <div className="container">
          ...
          <p>
            ...
            <FormattedMessage
              ...
              defaultMessage="Hede aims to create a true peer-to-peer sharing economy without middleman and zero transaction fee that allows people to transact safely and freely."
            />
          </p>
        </div>
      </div>
        ...
        <div className="container">
          ...
          <p>
            ...
            <FormattedMessage
              ...
              defaultMessage="Hede's goal is to end the remittance ripoff providing a digital wallet that allows everyone to send/receive digital money with no transaction fee."
            />
          </p>
        </div>
      </div>
